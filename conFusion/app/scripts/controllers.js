...
angular.module('confusionApp')
        ...
        .controller('DishCommentController', ['$scope', 'menuFactory', function($scope, menuFactory) {
            $scope.info = { rating:5, comment:"", firstName:"", lastName:"" };
            $scope.mycomment = {rating:5, comment:"", author:"", date:""};

            $scope.submitComment = function () {

                $scope.mycomment.author = $scope.info.firstName + " " + $scope.info.lastName;
                $scope.mycomment.rating = $scope.info.rating;
                $scope.mycomment.comment = $scope.info.comment;
